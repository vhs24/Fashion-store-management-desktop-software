...
public class BarChart extends JPanel
{
    ...
    public void addHistogramColumn(String label, String string, Color color)
    {
        Bar bar = new Bar(label, string, color);
        bars.add( bar );
    }
    ...
    public void layoutHistogram() throws ParseException
    {
        ...
        for (Bar bar: bars)
            maxValue = Math.max(maxValue, currencyVN.parse(bar.getValue()).doubleValue());
        ...
        for (Bar bar: bars)
        {
            ...
            double barHeight = (currencyVN.parse(bar.getValue()).doubleValue() * histogramHeight) / maxValue;
    ...
    private class Bar
    {
        ...
        public Bar(String label, String string, Color color)
        {
            this.label = label;
            this.value = string;
            this.color = color;
